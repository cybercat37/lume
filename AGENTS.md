...
See `ROADMAP.md` for the full 12-step program, `STEP1_PIPELINE.md` for Step 1, `STEP2_CORE_SYNTAX.md` for Step 2, `STEP3_PARSER_ROBUSTNESS.md` for Step 3, `STEP4_BINDING_SCOPE.md` for Step 4, `STEP5_TYPE_SYSTEM.md` for Step 5, and `STEP6_INTERPRETER.md` for Step 6.

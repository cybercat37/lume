...
Axom does not support traditional comments.

Instead, Axom introduces **intent annotations**: structured, machine-readable metadata that express developer intention and are treated as part of the program semantics.
...
They allow Axom to treat documentation as a **reflection of code meaning**, not an external artifact.

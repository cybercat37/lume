...
public class CodegenLenAbsMinMaxBuiltinTests
{
    ...
    public void Codegen_len_emits_length()
    {
        ...
        var result = compiler.Compile("print len(\"hello\")", "test.axom");
    ...
    {
        var compiler = new CompilerDriver();
        var result = compiler.Compile("print abs(-5)", "test.axom");
    ...
    {
        var compiler = new CompilerDriver();
        var result = compiler.Compile("print min(5, 10)", "test.axom");
    ...
    {
        var compiler = new CompilerDriver();
        var result = compiler.Compile("print max(5, 10)", "test.axom");

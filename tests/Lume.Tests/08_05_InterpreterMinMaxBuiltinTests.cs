...
public class InterpreterMinMaxBuiltinTests
{
    ...
    {
        var sourceText = new SourceText("print min(5, 10)", "test.lume");
    ...
    {
        var sourceText = new SourceText("print min(5, 5)", "test.lume");
        var syntaxTree = SyntaxTree.Parse(sourceText);
    ...
    {
        var sourceText = new SourceText("print max(5, 10)", "test.lume");
        var syntaxTree = SyntaxTree.Parse(sourceText);
    ...
    {
        var sourceText = new SourceText("print max(5, 5)", "test.lume");
        var syntaxTree = SyntaxTree.Parse(sourceText);

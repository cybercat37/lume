...
public class CompilerPipelineTests
{
    ...
    {
        var compiler = new CompilerDriver();
        var result = compiler.Compile("print 42", "test.lume");
    ...
    {
        var compiler = new CompilerDriver();
        var result = compiler.Compile("print true", "test.lume");
    ...
    {
        var compiler = new CompilerDriver();
        var result = compiler.Compile("let x = 10", "test.lume");
    ...
    {
        var compiler = new CompilerDriver();
        var result = compiler.Compile("print 2 + 3 * 4", "test.lume");
    ...
    {
        var compiler = new CompilerDriver();
        var result = compiler.Compile("print -5", "test.lume");
